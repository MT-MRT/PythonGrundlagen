#In der letzen Aufgabe haben wie allgemin gelernt wie man eine Variable nutzt und die string Variable eingeführt, nun beschäftigen wir uns mit allen anderen möglichen Variablentypen
#Aufgabe 3
