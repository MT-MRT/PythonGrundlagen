...
So erweitern wir das Bespiel um einen weiteren Fall ob die Zahl größer 20 ist und wenn keine dieser Bedinungen eintritt. 
'''
...
Aufgabe: Schreibe ein if-else Statment das prüft ob eine Zahl durch zwei und durch drei ohne Rest teilbar ist. Mit einem elseif soll zudem noch überprüft werden ob die Zahl durch fünf ohne Rest teilbar ist. Trifft beides nicht zu soll mit else ein kurzer Satz der dies darlegt ausgegeben werden.
'''
