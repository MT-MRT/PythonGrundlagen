...
3. Der import für die Zufallszahl muss ganz oben im Programm stehen. Für das importieren von Modulen muss immer das Keyword "import" vor den Namen des Moduls gesetzt werden.
