...
#In der letzten Aufgaben haben wir gelernt, wie man eine Variable nutzt und die String Variable eingeführt, nun beschäftigen wir uns mit anderen möglichen Variablentypen

"""
Python macht dem Nutzer die Nutzung von Variablen sehr leicht. So muss man beim Deklarieren der Variablen in anderen Programmiersprachen wie Java erst den Datentyp der Variablen definiern z.b "int zahl = 3;" , eine Typdeklaration wie diese ist in Python nicht nötig. 
In Python werden Varaiablen in eine von drei Kategorien einsortiert:
1. String 
  z.B variablennamen1 = "Inhalt"
2. Zahl (Integer oder Float)
