...
'''
Wichtig ist sobald man ein Parameter in eine Funktion einbringt, muss der Wert dieses Parameters auch beim Funktionsaufruf übergeben werden. Probier es mal aus und lösche das "Sabrina", nun wird beim Ausführen eine Fehlermeldung kommen.
